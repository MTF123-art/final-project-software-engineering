...
<head>
    <title>Explore Sumenep - Verifikasi Email Anda</title>
                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <tr>
                        <td class="header"
                            ...
                            <!-- Logo -->
                            <a href="http://localhost" style="display: inline-block; text-decoration: none;">
                                <img src="
                                {{ asset('assets/img/logos/logo.png') }}
                                " alt="Explore Sumenep Logo"
                                    width="150" style="border: none; display: block; margin: 0 auto;">
                            </a>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            Klik tombol di bawah ini untuk memverifikasi alamat email Anda.</p>
                                        ...
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Jika tombol di atas tidak berfungsi, salin dan tempel tautan ini ke
                                            browser Anda:</p>
                                        <p
                                            style="box-sizing: border-box; font-family: monospace, monospace; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left; word-break: break-all;">
                                            <a href="{{ $url }}" target="_blank" rel="noopener"
                                                style="color: #3869d4;">{{ $url }}</a>
                                        </p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Jika Anda tidak membuat akun, Anda dapat mengabaikan email ini.
                                        </p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Terima kasih,<br>Tim Explore Sumenep
                                        </p>
                                        ...
                                        <table class="subcopy" width="100%" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td
                                                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;">
                                                    <p
                                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; line-height: 1.5em; margin-top: 0; font-size: 12px; color: #b0adc5;">
                                                        Jika Anda tidak meminta verifikasi ini, Anda dapat mengabaikan
                                                        email ini.
                                                    </p>
                                                </td>
                                            </tr>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © 2025 Explore Sumenep. Semua hak cipta dilindungi.
                                        </p>
                                    </td>
                                </tr>
                            </table>
