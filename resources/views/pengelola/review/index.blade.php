            ...
            <section class="container">
                <div class="d-lg-flex align-items-lg-end pb-4">
                    <div class="block-title me-auto">
                        <small class="sub-title">Manage review for</small>
                        <h1 class="display-5 title">Your Destination</h1>
                    </div>
                </div>
            </section>
                                            ...
                                            <tbody>
                                                ...
                                                @forelse ($reviews as $single)
                                                    <tr>
                                                        ...
                                                        <td class="text-nowrap">
                                                            <div class="d-flex flex-column">
                                                                <a href="./booking-details.html"
                                                                    class="link-dark link-hover"><strong>{{ $single->user->name }}</strong></a>
                                                            </div>
                                                        </td>
                                                        <td class="text-center">
                                                        ...
                                                        <td class="text-center">
                                                            <form
                                                                action="{{ route('pengelola.review.update', ['id' => $single->id]) }}"
