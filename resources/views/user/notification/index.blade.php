            ...
            <section class="container">
                <div class="d-lg-flex align-items-lg-end pb-4">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        <form method="POST" action="{{ route('user.notification.markAllRead') }}" class="m-2">
                            @csrf
                            <button type="submit" class="btn btn-sm btn-success">
                                Tandai semua sudah dibaca
                            </button>
                        </form>
                        <form method="POST" action="{{ route('user.notification.deleteAll') }}" class="m-2">
                            @csrf
                                    ...
                                    <div
                                        ...
                                        <div class="card-body d-flex justify-content-between align-items-start">
                                            ...
                                            <div class="ms-3 text-end">
                                                ...
                                                <form method="POST"
                                                    action="{{ route('user.notification.markRead', $notification->id) }}"
                                                ...
                                                @endif
                                                <form method="POST"
                                                    action="{{ route('user.notification.delete', $notification->id) }}"
                                                    class="d-inline-block m-2"
